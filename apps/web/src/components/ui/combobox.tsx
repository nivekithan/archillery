...
function ComboboxItem<T extends object>({
  ...
  return (
    <ListBoxItemPrimitive
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-md py-1 pr-1.5 pl-1.5 text-sm outline-hidden select-none data-selected:pr-8 data-focused:bg-muted data-focused:text-foreground data-focused:**:text-foreground data-highlighted:bg-muted data-highlighted:text-foreground data-highlighted:**:text-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
