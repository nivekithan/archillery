/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2aea474fc11dbe52f1c2262ca4d388c1)
...
interface __BaseEnv_CloudflareBindings {
	...
	GIT_CONTAINER: DurableObjectNamespace<import("./src/index").GitContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GitContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GIT_USERNAME" | "ARCHIL_META_DISK" | "ARCHIL_REGION" | "GIT_PASSWORD" | "ARCHIL_API_KEY">> {}
}
