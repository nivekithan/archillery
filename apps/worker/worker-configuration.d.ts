/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 74c72ee2ded7852faec70e4687f2d830)
// Runtime types generated with workerd@1.20260820.1 2026-08-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	SANDBOX_QUEUE: Queue;
	GIT_USERNAME: "nivekithan";
	ARCHIL_META_DISK: "dsk-00000000000642d2";
	ARCHIL_REGION: "aws-us-east-1";
	ARCHIL_SANDBOX_IMAGE: "ghcr.io/nivekithan/archillery@sha256:311055b9887f8bf14e3988ae89ea365a1f21727cb39db3ea7f64a14833ffe7fb";
	GIT_IDLE_TIMEOUT_SECONDS: 900;
	GIT_PASSWORD: string;
	ARCHIL_API_KEY: string;
	GIT_REPOSITORY: DurableObjectNamespace<import("./src/index").GitRepository>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GitRepository";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GIT_USERNAME" | "ARCHIL_META_DISK" | "ARCHIL_REGION" | "ARCHIL_SANDBOX_IMAGE" | "GIT_IDLE_TIMEOUT_SECONDS" | "GIT_PASSWORD" | "ARCHIL_API_KEY">> {}
}
